...
def visualisation():
    ...
    JCCoffee = correctfault2(JCCoffee, "dht22")
    #JCCoffee = correctfault(JCCoffee)
    ...
    JCLab = correctfault2(JCLab, "dht11")
...
def hourvisualisation(deviceid, start):
    ...
    data2 = correctfault2(data2, "dht22")
